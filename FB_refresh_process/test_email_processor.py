...
# Configuration Django avant l'import
import django
from django.conf import settings

# Configurer Django avant d'importer le module
...
from email_download import connect_db, save_file_to_db, process_new_emails, handle_zip_file
...
class TestEmailProcessor(unittest.TestCase):
    ...
    @patch('email_download.get_channel_layer')
    @patch('email_download.async_to_sync')
    @patch('email_download.connect_db')
    ...
    @patch('email_download.save_file_to_db')
    ...
    @patch('email_download.save_file_to_db')
    @patch('email_download.handle_zip_file')
...
if __name__ == "__main__":
    ...
    print("├── email_download.py       # Votre script original")
    print("├── test_email_processor.py # Ce script de test")
    print()
    
    # Vérifier que le module principal existe
    try:
        import email_download
        print("✅ Module email_download trouvé")
    except ImportError as e:
        print(f"❌ Erreur d'import: {e}")
        print("Assurez-vous que votre script s'appelle 'email_download.py'")
        sys.exit(1)
